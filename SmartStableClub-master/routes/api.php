...
//Route::post('horses/{id}','Api\HorseController@update');
Route::middleware('auth:api')->group(function () {
    Route::resource('roles','Api\RoleController');
    Route::resource('users','Api\UserController');
    Route::resource('horses','Api\HorseController');
    Route::resource('horse-parents','Api\HorseParentController');
    Route::get('horse-file/{horse_id}','Api\HorseFileController@index');
