    ...
    [
      _c("span", [
        ...
        _c(
          ...
          {
            attrs: {
              href: "https://equinesolutions.co",
              target: "_blank",
              rel: "nofollow"
            }
          },
          [_vm._v("Equine Solutions")]
        ),
      ...
      [
        _c(
          ...
          [
            ...
            _c(
              "vx-tooltip",
              { attrs: { text: "Search", position: "bottom" } },
              [
                _c("feather-icon", {
                  staticClass: "cursor-pointer navbar-fuzzy-search ml-4 mt-1",
            ...
            _c(
              "vx-tooltip",
              { attrs: { text: "Clients", position: "bottom" } },
              [
                _c("feather-icon", {
                  staticClass: "cursor-pointer ml-4 mt-1",
                  attrs: { icon: "SmileIcon" },
                  on: {
                    click: function($event) {
                      return _vm.$router.push("/client")
                    }
                  }
                })
              ],
            ...
            _c(
              "vx-tooltip",
              { attrs: { text: "Horses", position: "bottom" } },
              [
                _c("feather-icon", {
                  staticClass: "cursor-pointer ml-4 mt-1",
            ...
            _c(
              ...
              [
                _c(
                  "vx-tooltip",
                  { attrs: { text: "Notifications", position: "bottom" } },
                  [
                    _c("feather-icon", {
                          ...
                          [
                            ...
                            _c(
                              "li",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.$router.push("/coming-soon")
                                  }
                                }
                              },
                              [
                    ...
                    _c(
                      ...
                      [
                        !_vm.hideScrollToTop
                          ? _c(
                              "back-to-top",
                              { attrs: { bottom: "5%", visibleoffset: "200" } },
                              [
                                _c("vs-button", {
