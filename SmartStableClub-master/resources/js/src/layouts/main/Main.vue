...
<template>
    <div class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]">
        ...
        <vx-sidebar :sidebarItems="sidebarItems" :logo="require('@assets/images/logo/logo.png')" title="Smartstable" parent=".layout--main" />
                ...
                <div class="router-view">
                    <div class="router-content" :class="{'mt-0': navbarType == 'hidden'}">
                        ...
                        <div class="content-area__content">
                            <back-to-top bottom="5%" visibleoffset="200" v-if="!hideScrollToTop">
