...
<div class="relative">
	<div class="vx-navbar-wrapper">
		<vs-navbar class="vx-navbar navbar-custom" :color="navbarColor" :class="classObj">
            ...
            <vx-tooltip text="Search" position="bottom">
                <feather-icon icon="SearchIcon" @click="showFullSearch = true" class="cursor-pointer navbar-fuzzy-search ml-4 mt-1"></feather-icon>
            </vx-tooltip>
            ...
            <vx-tooltip text="Horses" position="bottom">
                <feather-icon icon="GitlabIcon" @click="$router.push('/horse')" class="cursor-pointer ml-4 mt-1"></feather-icon>
            </vx-tooltip>


			<!-- NOTIFICATIONS -->
			<vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer ml-4">
                <vx-tooltip text="Notifications" position="bottom">
				...
				<vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
					...
					<vs-dropdown-menu class="vx-navbar-dropdown">
						<ul style="min-width: 9rem">
                            ...
                            <vs-divider position="center">Settings</vs-divider>
							<li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white" @click="$router.push('/user')"><feather-icon icon="UsersIcon" svgClasses="w-4 h-4"></feather-icon> <span class="ml-2">Users</span></li>
							<li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white" @click="$router.push('/role')"><feather-icon icon="ShieldIcon" svgClasses="w-4 h-4"></feather-icon> <span class="ml-2">Roles</span></li>
							<li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white" @click="$router.push('/coming-soon')"><feather-icon icon="AlertCircleIcon" svgClasses="w-4 h-4"></feather-icon> <span class="ml-2">Club</span></li>
							<li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white" @click="$router.push('/coming-soon')"><feather-icon icon="BoxIcon" svgClasses="w-4 h-4"></feather-icon> <span class="ml-2">Services</span></li>
