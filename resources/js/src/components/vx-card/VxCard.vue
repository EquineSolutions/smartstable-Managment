...
<template>
    <div class="vx-card" ref="card" :class="[
        ...
        <div class="vx-card__header" v-if="hasHeader">
            ...
            <div class="vx-card__actions" v-else-if="hasNavigationButton">
                <vs-button size="small" v-if="buttonPermission!=null?can(buttonPermission):true" icon-pack="feather" :icon="buttonIcon" class="mb-4 md:mb-0" :to='buttonURL'>{{buttonText}}</vs-button>
            </div>
        </div>
