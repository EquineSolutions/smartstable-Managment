                ...
                <form>
                    ...
                    <div class="vx-row">
                        <div class="vx-col sm:w-1/2 w-full mb-6">
                            <vs-input v-validate="'required|decimal'" class="w-full" icon-pack="feather" icon="icon-mail" icon-no-border label-placeholder="Price" v-model="price" name='price' />
                    ...
                    <div class="vx-row">
                        <div class="dropbox">
                            ...
                            <img v-bind:src="logo" v-show="showPreview"/>
                        </div>
                    </div>
                    <div class="vx-row">
                        <label>Enable</label>
            ...
            submitForm() {
                ...
                this.$validator.validateAll().then(result => {
                    if(result) {
                        ...
                        axios.put(`/api/packages/${this.$route.params.id}`, data, store.state.config).then(function(response){
