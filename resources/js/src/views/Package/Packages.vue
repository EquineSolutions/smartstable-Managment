                            ...
                            <vs-row>
                                <div class="flex mb-4">
                                    <div class="w-1/3" v-if="can('package-list')">
                                        <vs-button @click="redirect('view-package', data[indextr].id)" radius color="primary" type="border" icon-pack="feather" icon="icon-eye"></vs-button>
                                    </div>
                                    <div class="w-1/3" style="margin: 0 10px;" v-if="can('package-edit')">
                                        <vs-button @click="redirect('edit-package', data[indextr].id)" radius color="warning" type="border" icon-pack="feather" icon="icon-edit"></vs-button>
                                    </div>
